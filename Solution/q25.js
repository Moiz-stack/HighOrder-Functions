...
// Use findIndex to get the position of Iran in the array. If it's not there, return -1.

// Check if "Iran" exists in the countries array and return its position. If it doesn’t exist, return -1.

const findIndexIran=countries.findIndex((country)=>{
    return country==='Iran'
})

console.log(findIndexIran)